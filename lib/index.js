class API {
    ...
    async get_map_scoreboard({ map_id = null } = {}) {
        return this.request("get_map_scoreboard", "GET", { map_id });
    }
    ...
    async get_scoreboard_maps({ page = 1 } = {}) {
        return this.request("get_scoreboard_maps", "GET", { page });
    }
